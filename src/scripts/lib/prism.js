...
(function (Prism) {
	...
	Prism.languages['log-file'] = {
		...
		'constant': [
			{
				pattern: /\b([0-9]+|true|false|null)\b/i, // bools and numbers
				greedy: true
			},
			{
			...
			{
				pattern: /([\w-]+\.)+([\w-])+(?![\w/\\])/i, // Match character and . sequences (such as namespaces) as well as file names and extensions (e.g. bar.txt)
				greedy: true
			}
		]
	};

	Prism.languages['log'] = Prism.languages['log-file'];
