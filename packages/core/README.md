...
This package contains JavaScript and TypeScript utilities that may imported and used by scripts in various @chocolatey-software/* packages and Chocolatey projects and websites.
