    ...
    "node_modules/@tarekraafat/autocomplete.js/dist/autoComplete.min.js"(exports, module) {
      ...
      t = exports, e = function() {
        ...
        function t2(t3, e3) {
          ...
          for (var n2 = 0, r2 = Array(e3); n2 < e3; n2++) r2[n2] = t3[n2];
          return r2;
        }
        function e2(t3, e3, n2) {
          ...
          })(e3)) in t3 ? Object.defineProperty(t3, e3, { value: n2, enumerable: true, configurable: true, writable: true }) : t3[e3] = n2, t3;
        }
        function n(t3, e3) {
        ...
        function r(t3) {
          for (var r2 = 1; r2 < arguments.length; r2++) {
            ...
            r2 % 2 ? n(Object(i2), true).forEach((function(n2) {
              e2(t3, n2, i2[n2]);
            })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t3, Object.getOwnPropertyDescriptors(i2)) : n(Object(i2)).forEach((function(e3) {
        ...
        function s(e3, n2) {
          if (e3) {
            if ("string" == typeof e3) return t2(e3, n2);
            var r2 = {}.toString.call(e3).slice(8, -1);
            return "Object" === r2 && e3.constructor && (r2 = e3.constructor.name), "Map" === r2 || "Set" === r2 ? Array.from(e3) : "Arguments" === r2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r2) ? t2(e3, n2) : void 0;
          }
        }
        var u = function(t3) {
          return "string" == typeof t3 ? document.querySelector(t3) : t3();
        }, a = function(t3, e3) {
          var n2 = "string" == typeof t3 ? document.createElement(t3) : t3;
          for (var r2 in e3) {
            var i2 = e3[r2];
          ...
          var r2 = n2 || {}, i2 = r2.mode, o2 = r2.diacritics, s2 = r2.highlight, u2 = c(e3, o2);
          if (e3 = String(e3), t3 = c(t3, o2), "loose" === i2) {
            var a2 = (t3 = t3.replace(/ /g, "")).length, f2 = 0, p2 = Array.from(e3).map((function(e4, n3) {
              return f2 < a2 && u2[n3] === t3[f2] && (e4 = s2 ? l(e4, s2) : e4, f2++), e4;
            })).join("");
            if (f2 === a2) return p2;
          } else {
            var d2 = u2.indexOf(t3);
            if (~d2) return t3 = e3.substring(d2, d2 + t3.length), d2 = s2 ? e3.replace(t3, l(t3, s2)) : e3;
          }
        }, d = function(t3, e3) {
          ...
          var n2 = e3.data, r2 = e3.searchEngine, i2 = [];
          n2.store.forEach((function(o3, u2) {
            var a2 = function(n3) {
              var s2 = n3 ? o3[n3] : o3, u3 = "function" == typeof r2 ? r2(t3, s2) : p(t3, s2, { mode: r2, diacritics: e3.diacritics, highlight: e3.resultItem.highlight });
              if (u3) {
            ...
            if (n2.keys) {
              var c2, l2 = (function(t4, e4) {
                var n3 = "undefined" != typeof Symbol && t4[Symbol.iterator] || t4["@@iterator"];
                if (!n3) {
                  if (Array.isArray(t4) || (n3 = s(t4)) || e4) {
                    n3 && (t4 = n3);
        ...
        function k(t3, e3) {
          ...
          return new Promise((function(i2, o2) {
            var s2, u2;
            return s2 = e3 || ((u2 = t3.input) instanceof HTMLInputElement || u2 instanceof HTMLTextAreaElement ? u2.value : u2.innerHTML), (function(t4, e4, n3) {
              return e4 ? e4(t4) : t4.length >= n3;
            })(s2 = t3.query ? t3.query(s2) : s2, t3.trigger, t3.threshold) ? d(t3, s2).then((function(e4) {
              try {
                return t3.feedback instanceof Error ? i2() : (h(s2, t3), t3.resultsList && (function(t4) {
                  var e5 = t4.resultsList, n3 = t4.list, i3 = t4.resultItem, o3 = t4.feedback, s3 = o3.matches, u3 = o3.results;
                  if (t4.cursor = -1, n3.innerHTML = "", s3.length || e5.noResults) {
                    var c3 = new DocumentFragment();
                    u3.forEach((function(t5, e6) {
                      var n4 = a(i3.tag, r({ id: "".concat(i3.id, "_").concat(e6), role: "option", innerHTML: t5.match, inside: c3 }, i3.class && { class: i3.class }));
                      i3.element && i3.element(n4, t5);
                    })), n3.append(c3), e5.element && e5.element(n3, o3), g(t4);
                  } else w(t4);
                })(t3), c2.call(n2));
              } catch (t4) {
                return o2(t4);
        ...
        var L = function(t3, e3) {
          for (var n2 in t3) for (var r2 in t3[n2]) e3(n2, r2);
        }, T = function(t3) {
          var e3, n2, i2, o2 = t3.events, s2 = (e3 = function() {
            return k(t3);
          }, n2 = t3.debounce, function() {
            ...
            !(function(t4, e5) {
              var n3 = e5.resultItem.tag.toUpperCase(), r2 = Array.from(e5.list.querySelectorAll(n3)), i3 = t4.target.closest(n3);
              i3 && i3.nodeName === n3 && j(e5, t4, r2.indexOf(i3));
            })(e4, t3);
          } } };
          L(a2, (function(e4, n3) {
            (t3.resultsList || "input" === n3) && (u2[e4][n3] || (u2[e4][n3] = a2[e4][n3]));
          })), L(u2, (function(e4, n3) {
            t3[e4].addEventListener(n3, u2[e4][n3]);
          }));
        };
        function E(t3) {
          var e3 = this;
          return new Promise((function(n2, i2) {
            var o2, s2, u2;
            if (o2 = t3.placeHolder, u2 = { role: "combobox", "aria-owns": (s2 = t3.resultsList).id, "aria-haspopup": true, "aria-expanded": false }, a(t3.input, r(r({ "aria-controls": s2.id, "aria-autocomplete": "both" }, o2 && { placeholder: o2 }), !t3.wrapper && r({}, u2))), t3.wrapper && (t3.wrapper = a("div", r({ around: t3.input, class: t3.name + "_wrapper" }, u2))), s2 && (t3.list = a(s2.tag, r({ dest: [s2.destination, s2.position], id: s2.id, role: "listbox", hidden: "hidden" }, s2.class && { class: s2.class }))), T(t3), t3.data.cache) return d(t3).then((function(t4) {
              try {
                return c2.call(e3);
              } catch (t5) {
                return i2(t5);
        ...
        function P(t3) {
          ...
          e3.init = function() {
            ...
            var e4;
            L((e4 = this).events, (function(t5, n2) {
              e4[t5].removeEventListener(n2, e4.events[t5][n2]);
            }));
          }, e3.open = function() {
            g(this);
          }, e3.close = function() {
        ...
        return function t3(e3) {
          this.options = e3, this.id = t3.instances = (t3.instances || 0) + 1, this.name = "autoComplete", this.wrapper = 1, this.threshold = 1, this.debounce = 0, this.resultsList = { position: "afterend", tag: "ul", maxResults: 5 }, this.resultItem = { tag: "li" }, (function(t4) {
            var e4 = t4.name, n2 = t4.options, r2 = t4.resultsList, i2 = t4.resultItem;
            for (var s2 in n2) if ("object" === o(n2[s2])) for (var a2 in t4[s2] || (t4[s2] = {}), n2[s2]) t4[s2][a2] = n2[s2][a2];
            else t4[s2] = n2[s2];
...
<p class="mb-0 text-end autocomplete-downloads"><small>${data.value.DownloadCount} downloads</small></p>`;
  ...
  // src/scripts/packages/ccr/ccr.js
  ...
  // src/scripts/set-deployment-method-cookie.js
  ...
  // src/scripts/collapse-topnav.js
  (() => {
  ...
  // src/scripts/packages/ccr/src/courses.js
  (() => {
  ...
  // packages/core/src/scripts/util/select-deployment-method-tab.js
  init_get_cookie();
  ...
  // src/scripts/modal-auto-close.js
  (() => {
