...
<div class="p-3 border-bottom">
    <a class="d-hash-none text-sm-center d-block small ${ee}" data-bs-toggle="collapse" href="#collapseTemplateHelp" role="button" aria-expanded="${ve}" aria-controls="collapseTemplateHelp">
        <i class="fa-solid fa-circle-question text-primary me-1"></i>Click to <span id="collapseTemplateHelpTextContainer">${me}</span> search help and examples.
    </a>
...
chocolatey_package '${p}' do
  ...
  version  '${S}'
  ${P}
end`}$.innerHTML=Po($.innerHTML),he($,"language-ruby");break;case"psdsc":for(let ke in Q){let _e=Q[ke].split(" , "),S=_e[1],p=Y(_e[3]),P=z(_e[3])?'chocoParams = "--prerelease"':"",ye=z(_e[3])?"    ":"";Le.innerHTML+=`
cChocoPackageInstaller ${p}
{
   ...
   Source  ${ye} = "${we}"
   ${P}
}`}Le.innerHTML=Po(Le.innerHTML),he(Le,"language-powershell");break;case"puppet":for(let ke in Q){let _e=Q[ke].split(" , "),S=_e[1],p=Y(_e[3]),P=z(_e[3])?"install_options => ['--prerelease'],":"",ye=z(_e[3])?"       ":"";Ee.innerHTML+=`
package { '${p}':
  ensure   ${ye} => '${S}',
  ${P}
