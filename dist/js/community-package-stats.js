/*!
  * choco-theme v0.6.1 (https://github.com/chocolatey/choco-theme#readme)
...
(() => {
  ...
  // js/src/package-stats.js
  var require_package_stats = __commonJS({
    "js/src/package-stats.js"(exports) {
      var import_jquery = __toESM(require_jquery());
      var animateStats = (el, v) => {
        v = v || "";
        const parent = el.parent();
        el.stop(true, true).animate({ top: 0.3 * parseInt(parent.height()) }, 350, "linear", () => {
          (0, import_jquery.default)(exports).html(v).css({ top: -0.8 * parseInt(parent.height()) }).animate({ top: 0 }, 350, "linear");
        });
      };
      var updateStats = (data, currData, key) => {
        const currentValue = currData[key] || "";
        const value = data[key].toString();
        const self = (0, import_jquery.default)(`#${key}`);
        if (currentValue != value) {
          ...
          if (currLength) {
            import_jquery.default.each(value.split("").reverse(), (index, element) => {
              const c = index <= currLength ? currentValue.charAt(currLength - index - 1) : "";
              if (c != element) {
                const el = (0, import_jquery.default)(items[length - index - 1]);
      ...
      var getStats = (currData) => {
        currData = currData || {};
        import_jquery.default.get("https://community.chocolatey.org/stats", (data) => {
          const section = (0, import_jquery.default)("section.aggstats");
          section.show();
      ...
      if (location.hostname !== "localhost" && location.hostname !== "127.0.0.1" && location.hostname !== "") {
        (0, import_jquery.default)(getStats);
      }
    }
  });

  // js/community-package-stats.js
  var import_package_stats = __toESM(require_package_stats());
})();
