...
?)|\\$(?!')|<(?!<)|<<str>>)+`.replace(/<<str>>/g, function() {
  ...
  var init_bootstrap_esm = __esm({
    "node_modules/bootstrap/dist/js/bootstrap.esm.js"() {
      ...
      Default$2 = __spreadProps(__spreadValues({}, Tooltip.Default), {
        content: "",
        offset: [0, 8],
        placement: "right",
      ...
      DefaultType$2 = __spreadProps(__spreadValues({}, Tooltip.DefaultType), {
  ...
  var outerHeightTrue, getOffset, getElementHeight, setCookieExpirationNever, getCookie, getParents, escapeId, convertEventTimeToLocal, copyCodeBlocks, selectDeploymentMethodTab, deploymentMethods, deploymentMethodHash, deploymentMethodHashArray;
  var init_chocolatey_functions = __esm({
    "js/src/util/chocolatey-functions.js"() {
      init_bootstrap_esm();
      init_luxon();
      outerHeightTrue = (el) => {
      ...
      escapeId = (el) => el.replace(/[.]/g, "\\$&");
      convertEventTimeToLocal = document.querySelectorAll(".convert-utc-to-local");
  ...
  // js/src/chocolatey-search.js
  var require_chocolatey_search = __commonJS({
    "js/src/chocolatey-search.js"(exports) {
      var import_autocomplete = __toESM(require_autoComplete_min());
      init_chocolatey_functions();
...
<p class="mb-0 text-end autocomplete-downloads"><small>${data.value.DownloadCount} downloads</small></p>`;
  ...
  // js/src/chocolatey-announcements.js
  init_chocolatey_functions();
  (() => {
  ...
  // js/src/chocolatey-authentication.js
  ...
  // js/src/chocolatey-carousels.js
  init_bootstrap_esm();
  (() => {
  ...
  // js/src/chocolatey-clipboard.js
  init_bootstrap_esm();
  ...
  // js/src/chocolatey-collapse-topnav.js
  init_bootstrap_esm();
  (() => {
  ...
  // js/src/chocolatey-dropdown-hover.js
  init_bootstrap_esm();
  (() => {
  ...
  // js/src/chocolatey-internal-url.js
  init_bootstrap_esm();
  init_chocolatey_functions();
  document.addEventListener("DOMContentLoaded", () => {
  ...
  // js/src/chocolatey-modal-auto-close.js
  init_bootstrap_esm();
  (() => {
      ...
      const findActiveRightNavLink = (scrollHash2) => {
        ...
        if ((0, import_jquery2.default)(scrollHash2).length) {
          if ((0, import_jquery2.default)(window).scrollTop() > (0, import_jquery2.default)(scrollHash2).offset().top - 30 && (0, import_jquery2.default)(scrollHash2).is(":visible")) {
            (0, import_jquery2.default)(`a[href="${scrollHash2}"]`).addClass("active active-page");
            (0, import_jquery2.default)(`a[href="${scrollHash2}"]`).parent().prev().find("a.active").removeClass("active active-page");
          } else {
            (0, import_jquery2.default)(`a[href="${scrollHash2}"]`).removeClass("active active-page");
          }
        }
      };
  ...
  // js/community.js
  var import_chocolatey_search = __toESM(require_chocolatey_search());

  // js/src/chocolatey-show-hide.js
  (() => {
