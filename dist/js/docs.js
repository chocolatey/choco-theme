...
?)|\\$(?!')|<(?!<)|<<str>>)+`.replace(/<<str>>/g, function() {
  ...
  // js/src/util/chocolatey-functions.js
  ...
  // js/src/ts/util/chocolatey-functions.ts
  var trimString = (item) => {
  ...
  // js/src/chocolatey-collapse-nested.js
  (() => {
    ...
    const changeHash = (el) => {
      el.addEventListener("click", (e2) => {
        if (history.pushState) {
          ...
          window.location.hash = e2.target.hash;
        }
      });
    };
  ...
  // js/src/chocolatey-collapse-responsive.js
  (() => {
  ...
  // js/src/chocolatey-collapse-y-height.js
  (() => {
  ...
  function D(e2, t2, n3, r2, o2, i2, c2, a2, u2, l3) {
    var s3, f2, p2, m2, v2, y2, b2, g2 = r2 && r2.__k || h, _2 = g2.length;
    for (n3.__k = [], s3 = 0; s3 < t2.length; s3++)
      if (null != (m2 = n3.__k[s3] = null == (m2 = t2[s3]) || "boolean" == typeof m2 ? null : "string" == typeof m2 || "number" == typeof m2 ? O(null, m2, null, null, m2) : Array.isArray(m2) ? O(S, { children: m2 }, null, null, null) : m2.__b > 0 ? O(m2.type, m2.props, m2.key, null, m2.__v) : m2)) {
        ...
        q(e2, m2, p2 = p2 || d, o2, i2, c2, a2, u2, l3), v2 = m2.__e, (f2 = m2.ref) && p2.ref != f2 && (b2 || (b2 = []), p2.ref && b2.push(p2.ref, null, m2), b2.push(f2, m2.__c || v2, m2)), null != v2 ? (null == y2 && (y2 = v2), "function" == typeof m2.type && null != m2.__k && m2.__k === p2.__k ? m2.__d = u2 = k(m2, u2, e2) : u2 = C(e2, m2, p2, g2, v2, u2), l3 || "option" !== n3.type ? "function" == typeof n3.type && (n3.__d = u2) : e2.value = "") : u2 && p2.__e == u2 && u2.parentNode != e2 && (u2 = j(p2));
      }
    for (n3.__e = y2, s3 = _2; s3--; )
  ...
  function N(e2, t2, n3) {
    "-" === t2[0] ? e2.setProperty(t2, n3) : e2[t2] = null == n3 ? "" : "number" != typeof n3 || y.test(t2) ? n3 : n3 + "px";
  }
  ...
  function q(e2, t2, n3, r2, o2, i2, c2, a2, u2) {
    var l3, f2, p2, m2, v2, d2, h2, y2, g2, _2, O2, j2 = t2.type;
      ...
      e:
        if ("function" == typeof j2) {
          if (y2 = t2.props, g2 = (l3 = j2.contextType) && r2[l3.__c], _2 = l3 ? g2 ? g2.props.value : l3.__ : r2, n3.__c ? h2 = (f2 = t2.__c = n3.__c).__ = f2.__E : ("prototype" in j2 && j2.prototype.render ? t2.__c = f2 = new j2(y2, _2) : (t2.__c = f2 = new w(y2, _2), f2.constructor = j2, f2.render = F), g2 && g2.sub(f2), f2.props = y2, f2.state || (f2.state = {}), f2.context = _2, f2.__n = r2, p2 = f2.__d = true, f2.__h = []), null == f2.__s && (f2.__s = f2.state), null != j2.getDerivedStateFromProps && (f2.__s == f2.state && (f2.__s = b({}, f2.__s)), b(f2.__s, j2.getDerivedStateFromProps(y2, f2.__s))), m2 = f2.props, v2 = f2.state, p2)
            ...
            if (null == j2.getDerivedStateFromProps && y2 !== m2 && null != f2.componentWillReceiveProps && f2.componentWillReceiveProps(y2, _2), !f2.__e && null != f2.shouldComponentUpdate && false === f2.shouldComponentUpdate(y2, f2.__s, _2) || t2.__v === n3.__v) {
              f2.props = y2, f2.state = f2.__s, t2.__v !== n3.__v && (f2.__d = false), f2.__v = t2, t2.__e = n3.__e, t2.__k = n3.__k, f2.__h.length && c2.push(f2);
              break e;
            }
  ...
  function M(e2, t2, n3, r2, o2, i2, c2, a2) {
    var u2, l3, s3, f2, p2 = n3.props, m2 = t2.props, v2 = t2.type, y2 = 0;
    ...
    if (null === v2)
      ...
      if (i2 = i2 && h.slice.call(e2.childNodes), l3 = (p2 = n3.props || d).dangerouslySetInnerHTML, s3 = m2.dangerouslySetInnerHTML, !a2) {
        if (null != i2)
      ...
      if (function(e3, t3, n4, r3, o3) {
        ...
        t2.__k = [];
      else if (y2 = t2.props.children, D(e2, Array.isArray(y2) ? y2 : [y2], t2, n3, r2, o2 && "foreignObject" !== v2, i2, c2, e2.firstChild, a2), null != i2)
        for (y2 = i2.length; y2--; )
          null != i2[y2] && g(i2[y2]);
  ...
  function B(e2, t2, n3) {
    var r2, o2, i2;
    s2.__ && s2.__(e2, t2), o2 = (r2 = "function" == typeof n3) ? null : n3 && n3.__k || t2.__k, i2 = [], q(t2, e2 = (!r2 && n3 || t2).__k = _(S, null, [e2]), o2 || d, d, void 0 !== t2.ownerSVGElement, !r2 && n3 ? [n3] : o2 ? null : t2.firstChild ? h.slice.call(t2.childNodes) : null, i2, !r2 && n3 ? n3 : o2 ? o2.__e : t2.firstChild, r2), L(i2, e2);
  }
  function V(e2, t2) {
    B(e2, t2, V);
  }
  ...
  var Be = { useState: ne, useReducer: re, useEffect: oe, useLayoutEffect: ie, useRef: function(e2) {
    ...
    var t2 = z.context[e2.__c], n3 = te(K++, 9);
  ...
  var Ze = Be.forwardRef(function(e2, t2) {
    var n3 = e2.translations, r2 = void 0 === n3 ? {} : n3, o2 = Qe(e2, Ke), i2 = r2.buttonText, c2 = void 0 === i2 ? "Search" : i2, a2 = r2.buttonAriaLabel, u2 = void 0 === a2 ? "Search" : a2, l3 = Je(ne(null), 2), s3 = l3[0], f2 = l3[1];
    return oe(function() {
      "undefined" != typeof navigator && (/(Mac|iPhone|iPod|iPad)/i.test(navigator.platform) ? f2("\u2318") : f2("Ctrl"));
    }, []), Be.createElement("button", ze({ type: "button", className: "DocSearch DocSearch-Button", "aria-label": u2 }, o2, { ref: t2 }), Be.createElement("span", { className: "DocSearch-Button-Container" }, Be.createElement(We, null), Be.createElement("span", { className: "DocSearch-Button-Placeholder" }, c2)), Be.createElement("span", { className: "DocSearch-Button-Keys" }, null !== s3 && Be.createElement(Be.Fragment, null, Be.createElement("kbd", { className: "DocSearch-Button-Key" }, "Ctrl" === s3 ? Be.createElement(Ve, null) : s3), Be.createElement("kbd", { className: "DocSearch-Button-Key" }, "K"))));
  });
  function Ye(e2, t2) {
    var n3 = void 0;
    return function() {
  ...
  function wt(e2) {
    for (var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 20, n3 = [], r2 = 0; r2 < e2.objectIDs.length; r2 += t2)
      n3.push(Ot(Ot({}, e2), {}, { objectIDs: e2.objectIDs.slice(r2, r2 + t2) }));
    return n3;
  }
  function jt(e2) {
    return e2.map(function(e3) {
      var t2 = e3.items, n3 = gt(e3, vt);
      return Ot(Ot({}, n3), {}, { objectIDs: (null == t2 ? void 0 : t2.map(function(e4) {
        return e4.objectID;
      })) || n3.objectIDs });
    });
  }
  function Et(e2) {
    var t2, n3, r2, o2 = (t2 = pt((e2.version || "").split(".").map(Number), 2), n3 = t2[0], r2 = t2[1], n3 >= 3 || 2 === n3 && r2 >= 4 || 1 === n3 && r2 >= 10);
    function i2(t3, n4, r3) {
      if (o2 && void 0 !== r3) {
        ...
        e2.apply(void 0, [t3].concat(yt(n4), [{ headers: c2 }]));
      } else
        e2.apply(void 0, [t3].concat(yt(n4)));
    }
    return { init: function(t3, n4) {
      ...
      t3.length > 0 && t3.reduce(function(e4, t4) {
        var n5 = t4.items, r3 = gt(t4, dt);
        return [].concat(yt(e4), yt(wt(Ot(Ot({}, r3), {}, { objectIDs: (null == n5 ? void 0 : n5.map(function(e5) {
          return e5.objectID;
  ...
  function Nt(e2) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var n3 = null != arguments[t2] ? arguments[t2] : {};
      t2 % 2 ? Ct(Object(n3), true).forEach(function(t3) {
        xt(e2, t3, n3[t3]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(n3)) : Ct(Object(n3)).forEach(function(t3) {
        Object.defineProperty(e2, t3, Object.getOwnPropertyDescriptor(n3, t3));
      });
    }
    return e2;
  ...
  var Tt = "https://cdn.jsdelivr.net/npm/search-insights@".concat("2.6.0", "/dist/search-insights.min.js");
  var Rt = Ye(function(e2) {
    var t2 = e2.onItemsChange, n3 = e2.items, r2 = e2.insights, o2 = e2.state;
    t2({ insights: r2, insightsEvents: Pt({ items: n3 }).map(function(e3) {
  ...
  function qt(e2) {
    var t2 = function(e3) {
      return Nt({ onItemsChange: function(e4) {
        ...
        t3.viewedObjectIDs.apply(t3, kt(n4.map(function(e5) {
          return Nt(Nt({}, e5), {}, { algoliaSource: [].concat(kt(e5.algoliaSource || []), ["autocomplete-internal"]) });
        })));
      }, onSelect: function(e4) {
        var t3 = e4.insights, n4 = e4.insightsEvents;
        t3.clickedObjectIDsAfterSearch.apply(t3, kt(n4.map(function(e5) {
          return Nt(Nt({}, e5), {}, { algoliaSource: [].concat(kt(e5.algoliaSource || []), ["autocomplete-internal"]) });
        })));
      }, onActive: ut }, e3);
    ...
    n3 || function(e3) {
      ...
      "string" == typeof n4 && (c2 = t3[n4]), c2 || (t3.AlgoliaAnalyticsObject = n4, t3[n4] || (t3[n4] = function() {
        ...
        try {
          ...
          n5.async = true, n5.src = Tt, n5.onerror = function() {
            console.error(t4);
    ...
    var a2 = Et(c2), u2 = { current: [] }, l3 = Ye(function(e3) {
      var t3 = e3.state;
      if (t3.isOpen) {
        ...
        at(u2.current.map(function(e4) {
          ...
          return e4.objectID;
        })) || (u2.current = n4, n4.length > 0 && Rt({ onItemsChange: r2, items: n4, insights: a2, state: t3 }));
      }
    }, 0);
    return { name: "aa.algoliaInsightsPlugin", subscribe: function(e3) {
      ...
      c2("addAlgoliaAgent", "insights-plugin"), t3({ algoliaInsightsPlugin: { __algoliaSearchParameters: { clickAnalytics: true }, insights: a2 } }), n4(function(e4) {
        ...
        It(t4) && o2({ state: n5, event: r4, insights: a2, item: t4, insightsEvents: [Nt({ eventName: "Item Selected" }, ft({ item: t4, items: u2.current }))] });
      }), r3(function(e4) {
        var t4 = e4.item, n5 = e4.state, r4 = e4.event;
        It(t4) && i2({ state: n5, event: r4, insights: a2, item: t4, insightsEvents: [Nt({ eventName: "Item Active" }, ft({ item: t4, items: u2.current }))] });
      });
  ...
  function Lt(e2) {
    (function(e3, t2) {
      if (!e3) {
        var n3 = t2.trim();
        st.current[n3] || (st.current[n3] = true, console.warn("[Autocomplete] ".concat(n3)));
      }
  ...
  function Mt(e2, t2) {
    ...
    return { then: function(t3, r2) {
      return Mt(e2.then(Ut(t3, n3, e2), Ut(r2, n3, e2)), n3);
    }, catch: function(t3) {
      return Mt(e2.catch(Ut(t3, n3, e2)), n3);
    }, finally: function(t3) {
      return t3 && n3.onCancelList.push(t3), Mt(e2.finally(Ut(t3 && function() {
    ...
    return { getState: function() {
      ...
      var c2 = function(e3) {
        for (var t3 = 1; t3 < arguments.length; t3++) {
          ...
          t3 % 2 ? Qt(Object(n4), true).forEach(function(t4) {
            Zt(e3, t4, n4[t4]);
          }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e3, Object.getOwnPropertyDescriptors(n4)) : Qt(Object(n4)).forEach(function(t4) {
  ...
  function ln(e2, t2) {
    ...
    return an(an({ debug: false, openOnFocus: false, placeholder: "", autoFocus: false, defaultActiveItemId: null, stallThreshold: 300, insights: false, environment: r2, shouldPanelOpen: function(e3) {
      ...
      return e3.sources;
    } }, e2), {}, { id: null !== (n3 = e2.id) && void 0 !== n3 ? n3 : "autocomplete-".concat(rt++), plugins: o2, initialState: an({ activeItemId: null, query: "", completion: null, collections: [], isOpen: false, status: "idle", context: {} }, e2.initialState), onStateChange: function(t3) {
      var n4;
      ...
      return Promise.all([].concat(rn(o2.map(function(e3) {
        ...
        return function(e4, t3) {
          ...
          return Promise.resolve(e4(t3)).then(function(e5) {
            return it(Array.isArray(e5), function() {
              ...
              if (it("string" == typeof e6.sourceId, "A source must provide a `sourceId` string."), n5.includes(e6.sourceId))
        ...
        return e3.map(function(e4) {
          return an(an({}, e4), {}, { onSelect: function(n5) {
  ...
  function pn(e2) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var n3 = null != arguments[t2] ? arguments[t2] : {};
      t2 % 2 ? fn2(Object(n3), true).forEach(function(t3) {
        mn(e2, t3, n3[t3]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(n3)) : fn2(Object(n3)).forEach(function(t3) {
        Object.defineProperty(e2, t3, Object.getOwnPropertyDescriptor(n3, t3));
      });
    }
    return e2;
  ...
  function On(e2, t2, n3) {
    if (o2 = e2, Boolean(null == o2 ? void 0 : o2.execute)) {
      var r2 = "algolia" === e2.requesterId ? Object.assign.apply(Object, [{}].concat(bn(Object.keys(n3.context).map(function(e3) {
        var t3;
  ...
  function Sn(e2) {
    var t2 = e2.reduce(function(e3, t3) {
      ...
      var n3 = t3.searchClient, r2 = t3.execute, o2 = t3.requesterId, i2 = t3.requests, c2 = e3.find(function(e4) {
        return _n(t3) && _n(e4) && e4.searchClient === n3 && Boolean(o2) && e4.requesterId === o2;
      });
      if (c2) {
        var a2;
  ...
  function wn(e2, t2, n3) {
    return t2.map(function(t3) {
      ...
      return t3.onResolve({ source: t3, results: i2, items: a2, state: n3.getState() }), it(Array.isArray(a2), function() {
  ...
  var Nn;
  var xn = null;
  var Tn = (An = -1, Cn = -1, Nn = void 0, function(e2) {
    var t2 = ++An;
  ...
  function Rn(e2) {
    var t2 = e2.event, n3 = e2.nextState, r2 = void 0 === n3 ? {} : n3, o2 = e2.props, i2 = e2.query, c2 = e2.refresh, a2 = e2.store, u2 = kn(e2, En);
    ...
    var y2 = Ht(Tn(o2.getSources(In({ query: i2, refresh: c2, state: a2.getState() }, u2)).then(function(e3) {
      return Promise.all(e3.map(function(e4) {
        ...
        return function(e5) {
          ...
          return nt(n4.reshape({ sourcesBySourceId: i3, sources: Object.values(i3), state: r3 })).filter(Boolean).map(function(e6) {
  ...
  function Hn(e2) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var n3 = null != arguments[t2] ? arguments[t2] : {};
      t2 % 2 ? Mn(Object(n3), true).forEach(function(t3) {
        Un(e2, t3, n3[t3]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(n3)) : Mn(Object(n3)).forEach(function(t3) {
        Object.defineProperty(e2, t3, Object.getOwnPropertyDescriptor(n3, t3));
      });
    }
    return e2;
  ...
  var Vn = ["props", "refresh", "store"];
  var Wn = ["inputElement", "formElement", "panelElement"];
  var Kn = ["inputElement"];
  var zn = ["inputElement", "maxLength"];
  var Jn = ["sourceIndex"];
  var $n = ["sourceIndex"];
  var Qn = ["item", "source", "sourceIndex"];
  function Zn(e2, t2) {
    var n3 = Object.keys(e2);
    if (Object.getOwnPropertySymbols) {
      var r2 = Object.getOwnPropertySymbols(e2);
  ...
  function Yn(e2) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var n3 = null != arguments[t2] ? arguments[t2] : {};
      t2 % 2 ? Zn(Object(n3), true).forEach(function(t3) {
        Gn(e2, t3, n3[t3]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(n3)) : Zn(Object(n3)).forEach(function(t3) {
        Object.defineProperty(e2, t3, Object.getOwnPropertyDescriptor(n3, t3));
      });
    }
    return e2;
  }
  function Gn(e2, t2, n3) {
    return (t2 = function(e3) {
      var t3 = function(e4, t4) {
  ...
  function er(e2) {
    var t2 = e2.props, n3 = e2.refresh, r2 = e2.store, o2 = Xn(e2, Vn), i2 = function(e3, t3) {
    ...
    return { getEnvironmentProps: function(e3) {
      ...
      return Yn({ action: "", noValidate: true, role: "search", onSubmit: function(i3) {
        var c2;
        i3.preventDefault(), t2.onSubmit(Yn({ event: i3, refresh: n3, state: r2.getState() }, o2)), r2.dispatch("submit", null), null === (c2 = e3.inputElement) || void 0 === c2 || c2.blur();
      }, onReset: function(i3) {
        var c2;
        i3.preventDefault(), t2.onReset(Yn({ event: i3, refresh: n3, state: r2.getState() }, o2)), r2.dispatch("reset", null), null === (c2 = e3.inputElement) || void 0 === c2 || c2.focus();
      } }, Xn(e3, Kn));
    }, getLabelProps: function(e3) {
      var n4 = e3 || {}, r3 = n4.sourceIndex, o3 = Xn(n4, Jn);
      return Yn({ htmlFor: "".concat(i2(t2.id, r3), "-input"), id: "".concat(i2(t2.id, r3), "-label") }, o3);
    }, getInputProps: function(e3) {
      var i3;
      function c2(e4) {
        (t2.openOnFocus || Boolean(r2.getState().query)) && Rn(Yn({ event: e4, props: t2, query: r2.getState().completion || r2.getState().query, refresh: n3, store: r2 }, o2)), r2.dispatch("focus", null);
      }
      var a2 = e3 || {}, u2 = (a2.inputElement, a2.maxLength), l3 = void 0 === u2 ? 512 : u2, s3 = Xn(a2, zn), f2 = zt(r2.getState()), p2 = function(e4) {
      ...
      return Yn({ "aria-autocomplete": "both", "aria-activedescendant": r2.getState().isOpen && null !== r2.getState().activeItemId ? "".concat(t2.id, "-item-").concat(r2.getState().activeItemId) : void 0, "aria-controls": r2.getState().isOpen ? "".concat(t2.id, "-list") : void 0, "aria-labelledby": "".concat(t2.id, "-label"), value: r2.getState().completion || r2.getState().query, id: "".concat(t2.id, "-input"), autoComplete: "off", autoCorrect: "off", autoCapitalize: "off", enterKeyHint: m2, spellCheck: "false", autoFocus: t2.autoFocus, placeholder: t2.placeholder, maxLength: l3, type: "search", onChange: function(e4) {
        Rn(Yn({ event: e4, props: t2, query: e4.currentTarget.value.slice(0, l3), refresh: n3, store: r2 }, o2));
      }, onKeyDown: function(e4) {
        !function(e5) {
          var t3 = e5.event, n4 = e5.props, r3 = e5.refresh, o3 = e5.store, i4 = Fn(e5, Ln);
          if ("ArrowUp" === t3.key || "ArrowDown" === t3.key) {
            var c3 = function() {
              ...
              if (null !== o3.getState().activeItemId && e6) {
                ...
                u4.onActive(Hn({ event: t3, item: n5, itemInputValue: c4, itemUrl: a4, refresh: r3, source: u4, state: o3.getState() }, i4));
              }
            };
            t3.preventDefault(), false === o3.getState().isOpen && (n4.openOnFocus || Boolean(o3.getState().query)) ? Rn(Hn({ event: t3, props: n4, query: o3.getState().query, refresh: r3, store: o3 }, i4)).then(function() {
            ...
            t3.preventDefault();
            var u3 = zt(o3.getState()), l4 = u3.item, s4 = u3.itemInputValue, f3 = u3.itemUrl, p3 = u3.source;
            if (t3.metaKey || t3.ctrlKey)
              void 0 !== f3 && (p3.onSelect(Hn({ event: t3, item: l4, itemInputValue: s4, itemUrl: f3, refresh: r3, source: p3, state: o3.getState() }, i4)), n4.navigator.navigateNewTab({ itemUrl: f3, item: l4, state: o3.getState() }));
            else if (t3.shiftKey)
              void 0 !== f3 && (p3.onSelect(Hn({ event: t3, item: l4, itemInputValue: s4, itemUrl: f3, refresh: r3, source: p3, state: o3.getState() }, i4)), n4.navigator.navigateNewWindow({ itemUrl: f3, item: l4, state: o3.getState() }));
            else if (t3.altKey)
              ;
            else {
              if (void 0 !== f3)
                return p3.onSelect(Hn({ event: t3, item: l4, itemInputValue: s4, itemUrl: f3, refresh: r3, source: p3, state: o3.getState() }, i4)), void n4.navigator.navigate({ itemUrl: f3, item: l4, state: o3.getState() });
              Rn(Hn({ event: t3, nextState: { isOpen: false }, props: n4, query: s4, refresh: r3, store: o3 }, i4)).then(function() {
                p3.onSelect(Hn({ event: t3, item: l4, itemInputValue: s4, itemUrl: f3, refresh: r3, source: p3, state: o3.getState() }, i4));
              });
            }
          }
        }(Yn({ event: e4, props: t2, refresh: n3, store: r2 }, o2));
      }, onFocus: c2, onBlur: ut, onClick: function(n4) {
      ...
      return Yn({ id: "".concat(i2(t2.id, u2), "-item-").concat(c2.__autocomplete_id), role: "option", "aria-selected": r2.getState().activeItemId === c2.__autocomplete_id, onMouseMove: function(e4) {
        if (c2.__autocomplete_id !== r2.getState().activeItemId) {
          ...
          if (null !== r2.getState().activeItemId && t3) {
            ...
            l4.onActive(Yn({ event: e4, item: i3, itemInputValue: a3, itemUrl: u3, refresh: n3, source: l4, state: r2.getState() }, o2));
          }
        }
        ...
        (u3 ? Promise.resolve() : Rn(Yn({ event: e4, nextState: { isOpen: false }, props: t2, query: i3, refresh: n3, store: r2 }, o2))).then(function() {
          a2.onSelect(Yn({ event: e4, item: c2, itemInputValue: i3, itemUrl: u3, refresh: n3, source: a2, state: r2.getState() }, o2));
        });
      } }, l3);
    } };
  }
  ...
  function ir(e2) {
    var t2, n3, r2, o2, i2 = e2.plugins, c2 = e2.options, a2 = null === (t2 = ((null === (n3 = c2.__autocomplete_metadata) || void 0 === n3 ? void 0 : n3.userAgents) || [])[0]) || void 0 === t2 ? void 0 : t2.segment, u2 = a2 ? or({}, a2, Object.keys((null === (r2 = c2.__autocomplete_metadata) || void 0 === r2 ? void 0 : r2.options) || {})) : {};
  ...
  function cr(e2) {
    var t2, n3 = e2.state;
    return false === n3.isOpen || null === n3.activeItemId ? null : (null === (t2 = zt(n3)) || void 0 === t2 ? void 0 : t2.itemInputValue) || null;
  }
  function ar(e2) {
  ...
  var fr = function(e2, t2) {
    switch (t2.type) {
      ...
      case "ArrowDown":
        var n3 = lr(lr({}, e2), {}, { activeItemId: t2.payload.hasOwnProperty("nextActiveItemId") ? t2.payload.nextActiveItemId : Ft(1, e2.activeItemId, ot(e2), t2.props.defaultActiveItemId) });
        return lr(lr({}, n3), {}, { completion: cr({ state: n3 }) });
      case "ArrowUp":
  ...
  function hr(e2) {
    Lt(e2);
    var t2 = [], n3 = ln(e2, t2), r2 = Yt(fr, n3, function(e3) {
      var t3 = e3.prevState, r3 = e3.state;
      n3.onStateChange(vr({ prevState: t3, state: r3, refresh: c2, navigator: n3.navigator }, o2));
    }), o2 = function(e3) {
      var t3 = e3.store;
      return { setActiveItemId: function(e4) {
        ...
        var n4 = 0, r3 = e4.map(function(e5) {
          return en(en({}, e5), {}, { items: nt(e5.items).map(function(e6) {
            return en(en({}, e6), {}, { __autocomplete_id: n4++ });
          }) });
        });
    ...
    }({ store: r2 }), i2 = er(vr({ props: n3, refresh: c2, store: r2, navigator: n3.navigator }, o2));
    function c2() {
      return Rn(vr({ event: new Event("input"), nextState: { isOpen: r2.getState().isOpen }, props: n3, navigator: n3.navigator, query: r2.getState().query, refresh: c2, store: r2 }, o2));
    }
    if (e2.insights && !n3.plugins.some(function(e3) {
      ...
      n3.plugins.push(qt(a2));
    }
    return n3.plugins.forEach(function(e3) {
      var r3;
      return null === (r3 = e3.subscribe) || void 0 === r3 ? void 0 : r3.call(e3, vr(vr({}, o2), {}, { navigator: n3.navigator, refresh: c2, onSelect: function(e4) {
        t2.push({ onSelect: e4 });
    ...
    }({ metadata: ir({ plugins: n3.plugins, options: e2 }), environment: n3.environment }), vr(vr({ refresh: c2, navigator: n3.navigator }, i2), o2);
  }
  function yr(e2) {
  ...
  function Lr(e2) {
    var t2 = e2.translations, n3 = void 0 === t2 ? {} : t2, r2 = qr(e2, xr), o2 = n3.noResultsText, i2 = void 0 === o2 ? "No results for" : o2, c2 = n3.suggestedQueryText, a2 = void 0 === c2 ? "Try searching for" : c2, u2 = n3.reportMissingResultsText, l3 = void 0 === u2 ? "Believe this query should return results?" : u2, s3 = n3.reportMissingResultsLinkText, f2 = void 0 === s3 ? "Let us know." : s3, p2 = r2.state.context.searchSuggestions;
  ...
  function Wr(e2) {
    ...
    return _(void 0 === r2 ? "span" : r2, Ur(Ur({}, Br(e2, Mr)), {}, { dangerouslySetInnerHTML: { __html: Vr(t2, "_snippetResult.".concat(n3, ".value")) || Vr(t2, n3) } }));
  }
  function Kr(e2, t2) {
    return function(e3) {
      if (Array.isArray(e3))
  ...
  function $r(e2) {
    return e2.collection && 0 !== e2.collection.items.length ? Be.createElement("section", { className: "DocSearch-Hits" }, Be.createElement("div", { className: "DocSearch-Hit-source" }, e2.title), Be.createElement("ul", e2.getListProps(), e2.collection.items.map(function(t2, n3) {
      return Be.createElement(Qr, Jr({ key: [e2.title, t2.objectID].join(":"), item: t2, index: n3 }, e2));
    }))) : null;
  }
  function Qr(e2) {
    var t2 = e2.item, n3 = e2.index, r2 = e2.renderIcon, o2 = e2.renderAction, i2 = e2.getItemProps, c2 = e2.onItemClick, a2 = e2.collection, u2 = e2.hitComponent, l3 = Kr(Be.useState(false), 2), s3 = l3[0], f2 = l3[1], p2 = Kr(Be.useState(false), 2), m2 = p2[0], v2 = p2[1], d2 = Be.useRef(null), h2 = u2;
    return Be.createElement("li", Jr({ className: ["DocSearch-Hit", t2.__docsearch_parent && "DocSearch-Hit--Child", s3 && "DocSearch-Hit--deleting", m2 && "DocSearch-Hit--favoriting"].filter(Boolean).join(" "), onTransitionEnd: function() {
  ...
  function oo(e2) {
    return Be.createElement("div", { className: "DocSearch-Dropdown-Container" }, e2.state.collections.map(function(t2) {
      if (0 === t2.items.length)
        return null;
      var n3 = no(t2.items[0]);
      return Be.createElement($r, ro({}, e2, { key: t2.source.sourceId, title: n3, collection: t2, renderIcon: function(e3) {
        var n4, r2 = e3.item, o2 = e3.index;
        return Be.createElement(Be.Fragment, null, r2.__docsearch_parent && Be.createElement("svg", { className: "DocSearch-Hit-Tree", viewBox: "0 0 24 54" }, Be.createElement("g", { stroke: "currentColor", fill: "none", fillRule: "evenodd", strokeLinecap: "round", strokeLinejoin: "round" }, r2.__docsearch_parent !== (null === (n4 = t2.items[o2 + 1]) || void 0 === n4 ? void 0 : n4.__docsearch_parent) ? Be.createElement("path", { d: "M8 6v21M20 27H8.3" }) : Be.createElement("path", { d: "M8 6v42M20 27H8.3" }))), Be.createElement("div", { className: "DocSearch-Hit-icon" }, Be.createElement(Pr, { type: r2.type })));
  ...
  function uo(e2) {
    var t2 = e2.translations, n3 = void 0 === t2 ? {} : t2, r2 = ao(e2, io), o2 = n3.recentSearchesTitle, i2 = void 0 === o2 ? "Recent" : o2, c2 = n3.noRecentSearchesText, a2 = void 0 === c2 ? "No recent searches" : c2, u2 = n3.saveRecentSearchButtonTitle, l3 = void 0 === u2 ? "Save this search" : u2, s3 = n3.removeRecentSearchButtonTitle, f2 = void 0 === s3 ? "Remove this search from history" : s3, p2 = n3.favoriteSearchesTitle, m2 = void 0 === p2 ? "Favorite" : p2, v2 = n3.removeFavoriteSearchButtonTitle, d2 = void 0 === v2 ? "Remove this search from favorites" : v2;
  ...
  var po = Be.memo(function(e2) {
    var t2 = e2.translations, n3 = void 0 === t2 ? {} : t2, r2 = fo(e2, lo);
    if ("error" === r2.state.status)
      return Be.createElement(Nr, { translations: null == n3 ? void 0 : n3.errorScreen });
    var o2 = r2.state.collections.some(function(e3) {
      return e3.items.length > 0;
    });
    return r2.state.query ? false === o2 ? Be.createElement(Lr, so({}, r2, { translations: null == n3 ? void 0 : n3.noResultsScreen })) : Be.createElement(oo, r2) : Be.createElement(uo, so({}, r2, { hasCollections: o2, translations: null == n3 ? void 0 : n3.startScreen }));
  }, function(e2, t2) {
  ...
  function yo(e2) {
    var t2 = e2.translations, n3 = void 0 === t2 ? {} : t2, r2 = ho(e2, mo), o2 = n3.resetButtonTitle, i2 = void 0 === o2 ? "Clear the query" : o2, c2 = n3.resetButtonAriaLabel, a2 = void 0 === c2 ? "Clear the query" : c2, u2 = n3.cancelButtonText, l3 = void 0 === u2 ? "Cancel" : u2, s3 = n3.cancelButtonAriaLabel, f2 = void 0 === s3 ? "Cancel" : s3, p2 = r2.getFormProps({ inputElement: r2.inputRef.current }).onReset;
  ...
  function Oo(e2) {
    var t2 = e2.key, n3 = e2.limit, r2 = void 0 === n3 ? 5 : n3, o2 = _o(t2), i2 = o2.getItem().slice(0, r2);
    return { add: function(e3) {
      var t3 = e3, n4 = (t3._highlightResult, t3._snippetResult, go(t3, bo)), c2 = i2.findIndex(function(e4) {
  ...
  var Co = { Read: 1, Write: 2, Any: 3 };
  var No = 1;
  var xo = 2;
  var To = 3;
  function Ro(e2) {
    var n3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : No;
  ...
  function Uo(e2, n3, r2, o2) {
    var i2 = [], c2 = function(e3, n4) {
      if (e3.method === Lo || void 0 === e3.data && void 0 === n4.data)
        return;
    ...
    }(e2, o2), l3 = r2.method, s3 = r2.method !== Lo ? {} : t(t({}, r2.data), o2.data), f2 = t(t(t({ "x-algolia-agent": e2.userAgent.value }, e2.queryParameters), s3), o2.queryParameters), p2 = 0, m2 = function t2(n4, a2) {
      var s4 = n4.pop();
      if (void 0 === s4)
      ...
      var m3 = { data: c2, headers: u2, method: l3, url: Bo(s4, r2.path, f2), connectTimeout: a2(p2, e2.timeouts.connect), responseTimeout: a2(p2, o2.timeout) }, v2 = function(e3) {
        ...
        var o3 = v2(r3);
        return r3.isTimedOut && p2++, Promise.all([e2.logger.info("Retryable failure", Ko(o3)), e2.hostsCache.set(s4, Ro(s4, r3.isTimedOut ? To : xo))]).then(function() {
          return t2(n4, a2);
        });
      }, onFail: function(e3) {
    ...
    return Ho(e2.hostsCache, n3).then(function(e3) {
  ...
  function Bo(e2, t2, n3) {
    var r2 = Vo(n3), o2 = "".concat(e2.protocol, "://").concat(e2.url, "/").concat("/" === t2.charAt(0) ? t2.substr(1) : t2);
    return r2.length && (o2 += "?".concat(r2)), o2;
  }
  function Vo(e2) {
    return Object.keys(e2).map(function(t2) {
      return Do("%s=%s", t2, (n3 = e2[t2], "[object Object]" === Object.prototype.toString.call(n3) || "[object Array]" === Object.prototype.toString.call(n3) ? JSON.stringify(e2[t2]) : e2[t2]));
      var n3;
    }).join("&");
  }
  function Wo(e2) {
  ...
  var zo = function(e2) {
    var n3 = e2.appId, r2 = /* @__PURE__ */ function(e3, t2, n4) {
    ...
    }(void 0 !== e2.authMode ? e2.authMode : ko.WithinHeaders, n3, e2.apiKey), o2 = function(e3) {
      var t2 = e3.hostsCache, n4 = e3.logger, r3 = e3.requester, o3 = e3.requestsCache, i3 = e3.responsesCache, a2 = e3.timeouts, u2 = e3.userAgent, l3 = e3.hosts, s3 = e3.queryParameters, f2 = { hostsCache: t2, logger: n4, requester: r3, requestsCache: o3, responsesCache: i3, timeouts: a2, userAgent: u2, headers: e3.headers, queryParameters: s3, hosts: l3.map(function(e4) {
        ...
        var n5 = Ao(t3, f2.timeouts.read), r4 = function() {
      ...
      return f2;
    }(t(t({ hosts: [{ url: "".concat(n3, "-dsn.algolia.net"), accept: Co.Read }, { url: "".concat(n3, ".algolia.net"), accept: Co.Write }].concat(Po([{ url: "".concat(n3, "-1.algolianet.com") }, { url: "".concat(n3, "-2.algolianet.com") }, { url: "".concat(n3, "-3.algolianet.com") }])) }, e2), {}, { headers: t(t(t({}, r2.headers()), { "content-type": "application/x-www-form-urlencoded" }), e2.headers), queryParameters: t(t({}, r2.queryParameters()), e2.queryParameters) })), i2 = { transporter: o2, appId: n3, addAlgoliaAgent: function(e3, t2) {
  ...
  var Zo = function(e2) {
    return function(n3, r2) {
      return Promise.all(n3.map(function(n4) {
        var o2 = n4.params, c2 = o2.facetName, a2 = o2.facetQuery, u2 = i(o2, So);
        return $o(e2)(n4.indexName, { methods: { searchForFacetValues: Xo } }).searchForFacetValues(c2, a2, t(t({}, r2), u2));
      }));
    };
  };
  var Yo = function(e2) {
    return function(t2, n3, r2) {
      return e2.transporter.read({ method: Mo, path: Do("1/answers/%s/prediction", e2.indexName), data: { query: t2, queryLanguages: n3 }, cacheable: true }, r2);
    };
  };
  var Go = function(e2) {
    return function(t2, n3) {
      return e2.transporter.read({ method: Mo, path: Do("1/indexes/%s/query", e2.indexName), data: { query: t2 }, cacheable: true }, n3);
    };
  };
  var Xo = function(e2) {
    return function(t2, n3, r2) {
      return e2.transporter.read({ method: Mo, path: Do("1/indexes/%s/facets/%s/query", e2.indexName, t2), data: { facetQuery: n3 }, cacheable: true }, r2);
    };
  };
  var ei = 1;
  var ti = 2;
  var ni = 3;
  function ri(e2, n3, r2) {
  ...
  function ai(e2) {
    for (var t2 = 1; t2 < arguments.length; t2++) {
      var n3 = null != arguments[t2] ? arguments[t2] : {};
      t2 % 2 ? ci(Object(n3), true).forEach(function(t3) {
        ui(e2, t3, n3[t3]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(n3)) : ci(Object(n3)).forEach(function(t3) {
        Object.defineProperty(e2, t3, Object.getOwnPropertyDescriptor(n3, t3));
      });
    }
    return e2;
  ...
  function pi(e2) {
    var t2 = e2.appId, n3 = e2.apiKey, r2 = e2.indexName, o2 = e2.placeholder, i2 = void 0 === o2 ? "Search docs" : o2, c2 = e2.searchParameters, a2 = e2.maxResultsPerGroup, u2 = e2.onClose, l3 = void 0 === u2 ? Xr : u2, s3 = e2.transformItems, f2 = void 0 === s3 ? Yr : s3, p2 = e2.hitComponent, m2 = void 0 === p2 ? _r : p2, v2 = e2.resultsFooterComponent, d2 = void 0 === v2 ? function() {
      return null;
    } : v2, h2 = e2.navigator, y2 = e2.initialScrollY, b2 = void 0 === y2 ? 0 : y2, g2 = e2.transformSearchClient, _2 = void 0 === g2 ? Yr : g2, O2 = e2.disableUserPersonalization, S2 = void 0 !== O2 && O2, w2 = e2.initialQuery, j2 = void 0 === w2 ? "" : w2, E2 = e2.translations, P2 = void 0 === E2 ? {} : E2, I2 = e2.getMissingResultsUrl, D2 = e2.insights, k2 = void 0 !== D2 && D2, A2 = P2.footer, C2 = P2.searchBox, N2 = fi(P2, oi), x2 = li(Be.useState({ query: "", collections: [], completion: null, context: {}, isOpen: false, activeItemId: null, status: "idle" }), 2), T2 = x2[0], R2 = x2[1], q2 = Be.useRef(null), L2 = Be.useRef(null), M2 = Be.useRef(null), H2 = Be.useRef(null), U2 = Be.useRef(null), F2 = Be.useRef(10), B2 = Be.useRef("undefined" != typeof window ? window.getSelection().toString().slice(0, 64) : "").current, V2 = Be.useRef(j2 || B2).current, W2 = function(e3, t3, n4) {
      return Be.useMemo(function() {
        var r3 = ri(e3, t3);
        return r3.addAlgoliaAgent("docsearch", "3.5.2"), false === /docsearch.js \(.*\)/.test(r3.transporter.userAgent.value) && r3.addAlgoliaAgent("docsearch-react", "3.5.2"), n4(r3);
      }, [e3, t3, n4]);
    }(t2, n3, _2), K2 = Be.useRef(Oo({ key: "__DOCSEARCH_FAVORITE_SEARCHES__".concat(r2), limit: 10 })).current, z2 = Be.useRef(Oo({ key: "__DOCSEARCH_RECENT_SEARCHES__".concat(r2), limit: 0 === K2.getAll().length ? 7 : 4 })).current, J2 = Be.useCallback(function(e3) {
      if (!S2) {
      ...
      return hr({ id: "docsearch", defaultActiveItemId: 0, placeholder: i2, openOnFocus: true, initialState: { query: V2, context: { searchSuggestions: [] } }, insights: k2, navigator: h2, onStateChange: function(e3) {
        ...
        return W2.search([{ query: o3, indexName: r2, params: ai({ attributesToRetrieve: ["hierarchy.lvl0", "hierarchy.lvl1", "hierarchy.lvl2", "hierarchy.lvl3", "hierarchy.lvl4", "hierarchy.lvl5", "hierarchy.lvl6", "content", "type", "url"], attributesToSnippet: ["hierarchy.lvl1:".concat(F2.current), "hierarchy.lvl2:".concat(F2.current), "hierarchy.lvl3:".concat(F2.current), "hierarchy.lvl4:".concat(F2.current), "hierarchy.lvl5:".concat(F2.current), "hierarchy.lvl6:".concat(F2.current), "content:".concat(F2.current)], snippetEllipsisText: "\u2026", highlightPreTag: "<mark>", highlightPostTag: "</mark>", hitsPerPage: 20, clickAnalytics: p3 }, c2) }]).catch(function(e4) {
          ...
          var o4 = e4.results[0], c3 = o4.hits, s5 = o4.nbHits, m3 = Zr(c3, function(e5) {
            return no(e5);
          }, a2);
            ...
            return { sourceId: "hits".concat(t3), onSelect: function(e6) {
              ...
              return Object.values(Zr(e5, function(e6) {
                ...
                return e6.map(function(t4) {
                  ...
                  return "lvl1" !== t4.type && r3 && (n4 = r3), ai(ai({}, t4), {}, { __docsearch_parent: n4 }, v3);
                });
              }).flat();
            } };
          });
    ...
    }, [r2, c2, a2, W2, l3, z2, K2, J2, V2, i2, h2, f2, S2, k2, t2, n3]), Z2 = Q2.getEnvironmentProps, Y2 = Q2.getRootProps, G2 = Q2.refresh;
    return function(e3) {
    ...
    } }), Be.createElement("div", { className: "DocSearch-Modal", ref: L2 }, Be.createElement("header", { className: "DocSearch-SearchBar", ref: M2 }, Be.createElement(yo, ii({}, Q2, { state: T2, autoFocus: 0 === V2.length, inputRef: U2, isFromSelection: Boolean(V2) && V2 === B2, translations: C2, onClose: l3 }))), Be.createElement("div", { className: "DocSearch-Dropdown", ref: H2 }, Be.createElement(po, ii({}, Q2, { indexName: r2, state: T2, hitComponent: m2, resultsFooterComponent: d2, disableUserPersonalization: S2, recentSearches: z2, favoriteSearches: K2, inputRef: U2, translations: N2, getMissingResultsUrl: I2, onItemClick: function(e3, t3) {
      $2(e3), J2(e3), Gr(t3) || l3();
  ...
  function hi(e2) {
    var t2, n3, r2 = Be.useRef(null), o2 = vi(Be.useState(false), 2), i2 = o2[0], c2 = o2[1], a2 = vi(Be.useState((null == e2 ? void 0 : e2.initialQuery) || void 0), 2), u2 = a2[0], l3 = a2[1], s3 = Be.useCallback(function() {
      c2(true);
    ...
    return function(e3) {
      ...
      c2(true), l3(e3.key);
    }, [c2, l3]), searchButtonRef: r2 }), Be.createElement(Be.Fragment, null, Be.createElement(Ze, { ref: r2, translations: null == e2 || null === (t2 = e2.translations) || void 0 === t2 ? void 0 : t2.button, onClick: s3 }), i2 && Ie(Be.createElement(pi, mi({}, e2, { initialScrollY: window.scrollY, initialQuery: u2, translations: null == e2 || null === (n3 = e2.translations) || void 0 === n3 ? void 0 : n3.modal, onClose: f2 })), document.body));
  }
  function yi(e2) {
  ...
  // js/src/chocolatey-docsearch.js
  esm_default({
    appId: "S4T2OSB07R",
  ...
  // js/src/chocolatey-scrollspy.js
  ...
  // js/src/ts/chocolatey-tab-multiples.ts
  window.addEventListener("DOMContentLoaded", () => {
  ...
  (() => {
    ...
    if (themeSelectorToggles) {
      const copyCheckboxValue = (el) => {
        for (const i2 of themeSelectorToggles) {
          if (el.checked) {
            i2.checked = true;
          } else {
            i2.checked = false;
      ...
      themeSelectorToggles.forEach((el) => {
        ...
        const setAdditionalClasses = (themePrefers) => {
          if (themePrefers == "dark") {
            for (const i2 of tables) {
              i2.classList.add("table-dark");
            }
          } else {
            for (const i2 of tables) {
              i2.classList.remove("table-dark");
            }
          }
        };
        ...
        const setSystemTheme = (e2) => {
          const themeSystem = e2.matches ? "dark" : "light";
          if (!themeStorage) {
