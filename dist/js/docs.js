...
(() => {
  ...
  function E(e2, t2) {
    if (null == t2)
      return e2.__ ? E(e2.__, e2.__i + 1) : null;
  ...
  function I() {
    ...
    for (i.sort(u); e2 = i.shift(); )
      e2.__d && (t2 = i.length, o2 = void 0, c2 = (a2 = (n3 = e2).__v).__e, l3 = [], s3 = [], n3.__P && ((o2 = _({}, a2)).__v = a2.__v + 1, r.vnode && r.vnode(o2), R(n3.__P, o2, a2, n3.__n, n3.__P.namespaceURI, 32 & a2.__u ? [c2] : null, l3, null == c2 ? E(a2) : c2, !!(32 & a2.__u), s3), o2.__v = a2.__v, o2.__.__k[o2.__i] = o2, L(l3, o2, s3), o2.__e != c2 && j(o2)), i.length > t2 && i.sort(u));
    I.__r = 0;
  }
  function k(e2, t2, n3, r2, o2, i2, a2, c2, u2, l3, s3) {
    ...
    for (u2 = function(e3, t3, n4, r3, o3) {
      ...
      for (e3.__k = new Array(o3), i3 = 0; i3 < o3; i3++)
        null != (a3 = t3[i3]) && "boolean" != typeof a3 && "function" != typeof a3 ? (u3 = i3 + p3, (a3 = e3.__k[i3] = "string" == typeof a3 || "number" == typeof a3 || "bigint" == typeof a3 || a3.constructor == String ? S(null, a3, null, null, null) : y(a3) ? S(O, { children: a3 }, null, null, null) : void 0 === a3.constructor && a3.__b > 0 ? S(a3.type, a3.props, a3.key, a3.ref ? a3.ref : null, a3.__v) : a3).__ = e3, a3.__b = e3.__b + 1, c3 = null, -1 !== (l4 = a3.__i = x(a3, n4, u3, f3)) && (f3--, (c3 = n4[l4]) && (c3.__u |= 2)), null == c3 || null === c3.__v ? (-1 == l4 && p3--, "function" != typeof a3.type && (a3.__u |= 4)) : l4 != u3 && (l4 == u3 - 1 ? p3-- : l4 == u3 + 1 ? p3++ : (l4 > u3 ? p3-- : p3++, a3.__u |= 4))) : e3.__k[i3] = null;
      if (f3)
        for (i3 = 0; i3 < s4; i3++)
          null != (c3 = n4[i3]) && !(2 & c3.__u) && (c3.__e == r3 && (r3 = E(c3)), H(c3, c3));
      return r3;
    }(n3, t2, b2, u2, w2), f2 = 0; f2 < w2; f2++)
      null != (m2 = n3.__k[f2]) && (p2 = -1 === m2.__i ? v : b2[m2.__i] || v, m2.__i = f2, g2 = R(e2, m2, p2, o2, i2, a2, c2, u2, l3, s3), d2 = m2.__e, m2.ref && p2.ref != m2.ref && (p2.ref && M(p2.ref, null, m2), s3.push(m2.ref, m2.__c || d2, m2)), null == _2 && null != d2 && (_2 = d2), 4 & m2.__u || p2.__k === m2.__k ? u2 = D(m2, u2, e2) : "function" == typeof m2.type && void 0 !== g2 ? u2 = g2 : d2 && (u2 = d2.nextSibling), m2.__u &= -7);
    return n3.__e = _2, u2;
  }
  function D(e2, t2, n3) {
    var r2, o2;
    if ("function" == typeof e2.type) {
      for (r2 = e2.__k, o2 = 0; r2 && o2 < r2.length; o2++)
        r2[o2] && (r2[o2].__ = e2, t2 = D(r2[o2], t2, n3));
      return t2;
    }
  ...
  function x(e2, t2, n3, r2) {
    ...
    if (null === u2 || u2 && a2 == u2.key && c2 === u2.type && !(2 & u2.__u))
      return n3;
    if (r2 > (null == u2 || 2 & u2.__u ? 0 : 1))
      for (o2 = n3 - 1, i2 = n3 + 1; o2 >= 0 || i2 < t2.length; ) {
        if (o2 >= 0) {
          if ((u2 = t2[o2]) && !(2 & u2.__u) && a2 == u2.key && c2 === u2.type)
            return o2;
          o2--;
        }
        if (i2 < t2.length) {
          if ((u2 = t2[i2]) && !(2 & u2.__u) && a2 == u2.key && c2 === u2.type)
            return i2;
          i2++;
        }
      }
  ...
  function N(e2, t2, n3, r2, o2) {
    ...
    e:
      if ("style" == t2)
        ...
        i2 = t2 != (t2 = t2.replace(l2, "$1")), t2 = t2.toLowerCase() in e2 || "onFocusOut" == t2 || "onFocusIn" == t2 ? t2.toLowerCase().slice(2) : t2.slice(2), e2.l || (e2.l = {}), e2.l[t2 + i2] = n3, n3 ? r2 ? n3.u = r2.u : (n3.u = s2, e2.addEventListener(t2, i2 ? p : f, i2)) : e2.removeEventListener(t2, i2 ? p : f, i2);
      else {
      ...
      if ("function" == typeof T2)
        try {
          ...
          if (p2.context = P2, p2.props = S2, p2.__P = e2, p2.__e = false, D2 = r.__r, C2 = 0, E2) {
            for (p2.state = p2.__s, p2.__d = false, D2 && D2(t2), f2 = p2.render(p2.props, p2.state, p2.context), x2 = 0; x2 < p2._sb.length; x2++)
              p2.__h.push(p2._sb[x2]);
            p2._sb = [];
          } else
            do {
        ...
        null == a2 && t2.__v == n3.__v ? (t2.__k = n3.__k, t2.__e = n3.__e) : u2 = t2.__e = q(n3.__e, t2, n3, o2, i2, a2, c2, l3, s3);
  ...
  function q(e2, t2, o2, i2, a2, c2, u2, l3, s3) {
    ...
    if ("svg" == w2 ? a2 = "http://www.w3.org/2000/svg" : "math" == w2 ? a2 = "http://www.w3.org/1998/Math/MathML" : a2 || (a2 = "http://www.w3.org/1999/xhtml"), null != c2) {
      for (f2 = 0; f2 < c2.length; f2++)
        if ((d2 = c2[f2]) && "setAttribute" in d2 == !!w2 && (w2 ? d2.localName == w2 : 3 == d2.nodeType)) {
          e2 = d2, c2[f2] = null;
          break;
        }
    }
    ...
    if (null === w2)
      ...
      if (c2 = c2 && n2.call(e2.childNodes), S2 = o2.props || v, !l3 && null != c2)
        for (S2 = {}, f2 = 0; f2 < e2.attributes.length; f2++)
          S2[(d2 = e2.attributes[f2]).name] = d2.value;
      for (f2 in S2)
        if (d2 = S2[f2], "children" == f2)
          ;
      ...
      for (f2 in O2)
        d2 = O2[f2], "children" == f2 ? h2 = d2 : "dangerouslySetInnerHTML" == f2 ? p2 = d2 : "value" == f2 ? _2 = d2 : "checked" == f2 ? b2 = d2 : l3 && "function" != typeof d2 || S2[f2] === d2 || N(e2, f2, d2, S2[f2], a2);
      if (p2)
        l3 || m2 && (p2.__html === m2.__html || p2.__html === e2.innerHTML) || (e2.innerHTML = p2.__html), t2.__k = [];
      else if (m2 && (e2.innerHTML = ""), k(e2, y(h2) ? h2 : [h2], t2, o2, i2, "foreignObject" == w2 ? "http://www.w3.org/1999/xhtml" : a2, c2, u2, c2 ? c2[0] : o2.__k && E(o2, 0), l3, s3), null != c2)
        for (f2 = c2.length; f2--; )
          g(c2[f2]);
  ...
  function H(e2, t2, n3) {
    ...
    if (o2 = e2.__k)
      for (i2 = 0; i2 < o2.length; i2++)
        o2[i2] && H(o2[i2], t2, n3 || "function" != typeof e2.type);
  ...
  function ve() {
    var e2 = re(K++, 11);
    if (!e2.__) {
      for (var t2 = W.__v; null !== t2 && !t2.__m && null !== t2.__; )
        t2 = t2.__;
  ...
  var Be = function(e2, t2, n3) {
    if (++n3[1] === n3[0] && e2.l.delete(t2), e2.props.revealOrder && ("t" !== e2.props.revealOrder[0] || !e2.l.size))
      for (n3 = e2.i; n3; ) {
        for (; n3.length > 3; )
          n3.pop()();
        if (n3[1] < n3[0])
  ...
  (Fe.prototype = new w()).__a = function(e2) {
    ...
    for (var n3 = t2.length; n3--; )
      this.l.set(t2[n3], this.i = [1, 0, this.i]);
    return e2.children;
  ...
  function Bt(e2, t2) {
    if (e2 === t2)
      return true;
    if (Ft(e2) || Ft(t2) || "function" == typeof e2 || "function" == typeof t2)
      return e2 === t2;
    ...
    var l3 = function(e3) {
      ...
      function i3(t4, n5, r4) {
        if (o3 && void 0 !== r4) {
          ...
          e3.apply(void 0, [t4].concat(Zt(n5)));
      }
        ...
        t4.length > 0 && t4.reduce(function(e5, t5) {
          ...
          return [].concat(Zt(e5), Zt(function(e6) {
            for (var t6 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 20, n7 = [], r5 = 0; r5 < e6.objectIDs.length; r5 += t6)
              n7.push(en(en({}, e6), {}, { objectIDs: e6.objectIDs.slice(r5, r5 + t6) }));
            return n7;
          ...
          Dn(e5).isComposing || function(e6) {
            ...
            if ("ArrowUp" === t4.key || "ArrowDown" === t4.key) {
              ...
              if (t4.metaKey || t4.ctrlKey)
                void 0 !== f3 && (p3.onSelect(vr({ event: t4, item: l5, itemInputValue: s4, itemUrl: f3, refresh: r4, source: p3, state: o4.getState() }, i4)), n5.navigator.navigateNewTab({ itemUrl: f3, item: l5, state: o4.getState() }));
              else if (t4.shiftKey)
                void 0 !== f3 && (p3.onSelect(vr({ event: t4, item: l5, itemInputValue: s4, itemUrl: f3, refresh: r4, source: p3, state: o4.getState() }, i4)), n5.navigator.navigateNewWindow({ itemUrl: f3, item: l5, state: o4.getState() }));
              else if (t4.altKey)
                ;
              else {
                if (void 0 !== f3)
                  return p3.onSelect(vr({ event: t4, item: l5, itemInputValue: s4, itemUrl: f3, refresh: r4, source: p3, state: o4.getState() }, i4)), void n5.navigator.navigate({ itemUrl: f3, item: l5, state: o4.getState() });
  ...
  var Eo = st.memo(function(e2) {
    ...
    if ("error" === r2.state.status)
      return st.createElement(oo, { translations: null == n3 ? void 0 : n3.errorScreen });
                ...
                return v3 = mt(jt().mark(function e7(l5, s5) {
                  ...
                  return jt().wrap(function(e8) {
                    for (; ; )
                      switch (e8.prev = e8.next) {
                        case 0:
                          if (p4 = !(j3.length > 2 && void 0 !== j3[2]) || j3[2], m4 = [], v4 = Bo(l5, s5), h3 = Vo(r5, l5.headers, s5.headers), d3 = "GET" === l5.method ? wt(wt({}, l5.data), s5.data) : {}, y3 = wt(wt(wt({}, i4), l5.queryParameters), d3), a4.value && (y3["x-algolia-agent"] = a4.value), s5 && s5.queryParameters)
...
@docsearch/js/dist/esm/index.js:
  (*! @docsearch/js 3.8.3 | MIT License | © Algolia, Inc. and contributors | https://docsearch.algolia.com *)
*/
