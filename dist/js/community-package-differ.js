...
(() => {
  ...
  // js/src/chocolatey-package-differ.js
  var require_chocolatey_package_differ = __commonJS({
    "js/src/chocolatey-package-differ.js"(exports) {
      (() => {
  ...
  var import_chocolatey_package_differ = __toESM(require_chocolatey_package_differ());
})();
